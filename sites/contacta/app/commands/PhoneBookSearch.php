 ...
 *
 */
class PhoneBookSearch extends Command
{
	/**
	 *	@var string
	 *
	 ...
	 */
	protected $signature = "mycommand {firstarg} {optionalarg?} {--sound} ";
	 ...
	 */
	protected $help = "Syntax: mycommand firstarg [optionalarg] [--sound] ";
	...
	{
		$this->write("Command <fg=yellow>mycommand2</> not implemented.");
	}
}
